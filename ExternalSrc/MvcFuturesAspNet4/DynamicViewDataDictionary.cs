namespace Microsoft.Web.Mvc.AspNet4 {
    ...
    internal class DynamicViewDataDictionary : DynamicObject {
        ...
        public ModelMetadata ModelMetadata {
            get {
                return _dictionary.ModelMetadata;
            }
            set {
                _dictionary.ModelMetadata = value;
            }
        }

        public ModelStateDictionary ModelState {
            get {
                return _dictionary.ModelState;
            }
        }

        public TemplateInfo TemplateInfo {
            get {
                return _dictionary.TemplateInfo;
            }
            set {
                _dictionary.TemplateInfo = value;
            }
        }
